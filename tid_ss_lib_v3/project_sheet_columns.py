...
ContingencyHours = '=(IF([Risk Factor]@row = "Low (5% Contingency)", 0.05, IF([Risk Factor]@row = "Medium (10% Contingency)", 0.1, ' \
                   'IF([Risk Factor]@row = "Med-High (25% Contingency)", 0.25, IF([Risk Factor]@row = "High (50% Contingency)", 0.5))))) * [Budgeted Quantity]@row'
...
ColData = { 'Task': { 'position'    : 0, 'type': 'TEXT_NUMBER',
           ...
           'Contingency Hours': { 'position'     : 20, 'type': 'TEXT_NUMBER',
                                  ...
                                  'ms_top'       : { 'forced': '',   'default': None, 'format': ",,1,,,,,,2,31,,13,2,1,2,,",  'formula': None },
                                  'ms_parent'    : { 'forced': '',   'default': None, 'format': ",,,,,,,,,23,,13,2,1,2,,",    'formula': None },
                                  'ms_task'      : { 'forced': None, 'default': None, 'format': ",,,,,,,,,18,,13,2,1,2,,",    'formula': None },
                                  'labor_top'    : { 'forced': '',   'default': None, 'format': ",,1,,,,,,2,31,,13,2,1,2,,",  'formula': '=SUM(CHILDREN())'},
                                  'labor_parent' : { 'forced': '',   'default': None, 'format': ",,,,,,,,,23,,13,2,1,2,,",    'formula': '=SUM(CHILDREN())'},
                                  'labor_task'   : { 'forced': None, 'default': 0,    'format': ",,,,,,,,,18,,13,2,1,2,,",    'formula': ContingencyHours},
                                  'labor_mstone' : { 'forced': None, 'default': 0,    'format': ",,,,,,,,,18,,13,2,1,2,,",    'formula': ContingencyHours},},
